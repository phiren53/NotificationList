        ...
        public string GetTabWiseQuery(string tabIdName)
        {
            ...
            switch (tabIdName)
            {
                case "tabSSN":
                    ...
                    OGSSN_Query = OGSSN_Query + ", CRA_UNIQUE_ID AS [UNIQUE ID] " + "\n";
                    OGSSN_Query = OGSSN_Query + ", CRA_PARENT_RECORD_ID AS [PARENT RECORD] " + "\n";
                    ...
                    OGSSN_Query = OGSSN_Query + "WHERE CRA_PARENT_RECORD_ID in (SELECT CRA_PARENT_RECORD_ID AS [PARENT RECORD] " + "\n";
                    OGSSN_Query = OGSSN_Query + "FROM FULL_POPULATION " + "\n";
                    ...
                    OGSSN_Query = OGSSN_Query + "order by CRA_PARENT_RECORD_ID, SSN;";
                    break;
                case "tabDOB":
                    OGSSN_Query = OGSSN_Query + "SELECT relativityid as [Relativity ID] " + "\n";
                    OGSSN_Query = OGSSN_Query + ", CRA_UNIQUE_ID AS [UNIQUE ID] " + "\n";
                    ...
                    OGSSN_Query = OGSSN_Query + ", CRA_MERGED_ADDRESS AS [MERGED ADDRESS] " + "\n";
                    OGSSN_Query = OGSSN_Query + "FROM FULL_POPULATION " + "\n";
                    OGSSN_Query = OGSSN_Query + "WHERE CRA_PARENT_RECORD_ID in (SELECT CRA_PARENT_RECORD_ID " + "\n";
                    OGSSN_Query = OGSSN_Query + "FROM FULL_POPULATION " + "\n";
                    OGSSN_Query = OGSSN_Query + "GROUP BY CRA_PARENT_RECORD_ID " + "\n";
                    OGSSN_Query = OGSSN_Query + "having count(distinct CRA_CLEAN_BIRTHDATE) > 1) " + "\n";
                    OGSSN_Query = OGSSN_Query + "order by CRA_PARENT_RECORD_ID;";
                    break;
                case "tabFN":
                    OGSSN_Query = OGSSN_Query + "SELECT relativityid as [Relativity ID] " + "\n";
                    OGSSN_Query = OGSSN_Query + ", CRA_UNIQUE_ID AS [UNIQUE ID] " + "\n";
                ...
                case "tabLN":
                    ...
                    OGSSN_Query = OGSSN_Query + "order by CRA_PARENT_RECORD_ID, LASTNAME;";
                    break;
                case "tabFNLN":
                    OGSSN_Query = OGSSN_Query + "SELECT relativityid as [Relativity ID] " + "\n";
                    OGSSN_Query = OGSSN_Query + ", CRA_UNIQUE_ID AS [UNIQUE ID] " + "\n";
                    ...
                    OGSSN_Query = OGSSN_Query + "order by CRA_PARENT_RECORD_ID, LASTNAME, FIRSTNAME;";
                    break;
